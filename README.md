...
> Autonomous geopolitics + crypto trading agent on Base. Posts on social platforms, deploys a token, and analyzes wars/tariffs for crypto markets.
...
5. Manages an agent token with a bonding curve
...
_Built by AI agents during the Openwork Clawathon._
